...
extension SchoolQueryFilter on QueryBuilder<School, School, QFilterCondition> {
  QueryBuilder<School, School, QAfterFilterCondition> levelIsNull() {
  ...
  QueryBuilder<School, School, QAfterFilterCondition> levelIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<School, School, QAfterFilterCondition> levelEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<School, School, QAfterFilterCondition> levelGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<School, School, QAfterFilterCondition> levelLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<School, School, QAfterFilterCondition> levelBetween(
    int? lower,
    int? upper, {
  ...
  QueryBuilder<School, School, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<School, School, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'name',
      ));
